...
const SoccerMatch = ({tab,ipdf,ipdfTab,toggleTab,isOpen}) => {
                    ...
                    {soccerId.map((seriesName, index) => (
                        <div className="matches-grid" key={index}>
                            ...
                            <div className={isOpen[index] ? "mg-items mg-grid-expand" : "mg-items"}>
                                {soccerMatches[seriesName]?.matches.map((item,i) => (
                                    <Link to={`/match-details/${item.sportid}/${item.eventid}`} key={i}>
                                        <div className="mg-item">
                                            <div className="block-one">
                                                <div className="left">
                    ...
                    {uniqueSoccer !== 0 ? (<>
                        {uniqueSoccer.map((seriesName2, index) =>
                            <div className="matches-grid" key={index}>
                                ...
                                <div className={isOpen[index] ? "mg-items mg-grid-expand" : "mg-items"}>
                                    {soccerToday[seriesName2]?.match.map((item,i) => (
                                        <Link to={`/match-details/${item.sportid}/${item.eventid}`} key={i}>
                                            <div className="mg-item">
                                                <div className="block-one">
                                                    <div className="left">
                    ...
                    {tomSoccerUnique !== 0 ? (<>
                        {tomSoccerUnique.map((seriesName3, index) =>
                            <div className="matches-grid" key={index}>
                                ...
                                <div className={isOpen[index] ? "mg-items mg-grid-expand" : "mg-items"}>
                                    {tomSoccerData[seriesName3]?.match.map((item,i) => (
                                        <Link to={`/match-details/${item.sportid}/${item.eventid}`} key={i}>
                                            <div className="mg-item">
                                                <div className="block-one">
                                                    <div className="left">
